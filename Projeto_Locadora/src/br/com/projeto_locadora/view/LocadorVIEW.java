...
public class LocadorVIEW extends javax.swing.JInternalFrame {     
    ...
    DateTimeFormatter formato = DateTimeFormatter.ofPattern("dd/MM/yyyy"); //Será utilizado para frmatar e converter o texto do campo val_cnh_loc para Date
    ...
    private void initComponents() {
        ...
        val_cnh_loc = new javax.swing.JFormattedTextField();
        ...
        try {
            val_cnh_loc.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(val_cnh_loc, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(val_cnh_loc, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    /**
     * Método utilizado para gravar os dados do locador.
     */
    private void gravar(){
        try{
            locadorDTO.setNom_pes(nom_pes.getText());
            locadorDTO.setEnd_pes(end_pes.getText());
            locadorDTO.setNum_pes(Integer.parseInt(num_pes.getText()));
            locadorDTO.setBai_pes(bai_pes.getText());
            locadorDTO.setCid_pes(cid_pes.getText());
            locadorDTO.setEst_pes(est_pes.getSelectedItem().toString());
            locadorDTO.setCep_pes(cep_pes.getText());
            locadorDTO.setCpf_cnpj_pes(cpf_cnpj_pes.getText());
            locadorDTO.setRg_ie_pes(rg_ie_pes.getText());
            locadorDTO.setVal_cnh_loc(Date.valueOf(LocalDate.parse(val_cnh_loc.getText(), formato)));
            locadorDTO.setTip_pes(2); //2 porque é Pessoa do tipo Locador
            
            JOptionPane.showMessageDialog(null,
                    locadorCTR.inserirLocador(locadorDTO)
            );
        }
        catch(Exception e){
    ...
    /**
     * Método utilizado para excluir os dados do locador.
     */
    private void excluir(){
       if(JOptionPane.showConfirmDialog(null, "Deseja Realmente excluir o Locador?","Aviso", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            JOptionPane.showMessageDialog(null,
                    locadorCTR.excluirLocador(locadorDTO)
            );
       }
    ...
    /**
     * Método utilizado para alterar os dados do locador.
     */
    private void alterar(){
        try{
            ...
            JOptionPane.showMessageDialog(null,
                    locadorCTR.alterarLocador(locadorDTO)
            );
        }
        catch(Exception e){}
    ...
    private void preencheTabela(String nom_pes){
        try{
            ...
            rs = locadorCTR.consultarLocador(locadorDTO, 1); //1 = é a pesquisa por nome na classe DAO
            while(rs.next()){
    ...
    private void preencheCampos(int id_pes){
        try{
            locadorDTO.setId_pes(id_pes);
            rs = locadorCTR.consultarLocador(locadorDTO, 2); //2 = é a pesquisa no id na classe DAO
            if(rs.next()){
                limpaCampos();
                ...
                val_cnh_loc.setText(rs.getString("validade_cnh"));
                            ...
                            if((cep_pes.getText().equalsIgnoreCase("")) || (cep_pes.getText().equalsIgnoreCase("  .   -   "))){
                                ...
                                if(cpf_cnpj_pes.getText().equalsIgnoreCase("")){
                                    ...
                                    if(rg_ie_pes.getText().equalsIgnoreCase("")){
                                        ...
                                        if((val_cnh_loc.getText().equalsIgnoreCase("")) || (val_cnh_loc.getText().equalsIgnoreCase("  /  /    "))){
                                            JOptionPane.showMessageDialog(null, "O campo Validade da CNH deve ser preenchido");
                                            val_cnh_loc.requestFocus();
                                            return false;
                                        }
                                        else{
                                            return true;
                                        }//Fecha else val_cnh_loc
    ...
    private javax.swing.JFormattedTextField val_cnh_loc;
    // End of variables declaration//GEN-END:variables
}//Fecha classe LocadorVIEW
